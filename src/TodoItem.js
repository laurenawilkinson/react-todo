...
class TodoItem extends Component {
  ...
  render () {
    ...
    const todoClass = `rounded-lg focus:outline-none border border-transparent mb-3 group flex ${completed ? 'bg-green-300 focus:border-green-400' : 'bg-gray-700 focus:border-gray-600' }`
