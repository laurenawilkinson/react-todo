...
class TodoItem extends Component {
  ...
  render () {
    ...
    const todoClass = `rounded-lg focus:outline-none border border-transparent mb-3 group flex ${completed ? 'bg-green-300 focus:border-green-300' : 'bg-gray-700 focus:border-gray-800' }`
    ...
    const textClass = `flex overflow-hidden font-medium items-center pl-3 py-3 flex-1 cursor-pointer  ${completed ? 'text-green-900' : 'text-indigo-100'}`
